...
def main(config_path):
    ...
    # Freeze text understanding components (pretrained linguistic knowledge)
    print("Freezing text_encoder and text_aligner...")
    for param in model.text_encoder.parameters():
        param.requires_grad = False
    for param in model.text_aligner.parameters():
        param.requires_grad = False
